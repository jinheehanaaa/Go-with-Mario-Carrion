...
// stdlib
// Make name nullable so that if 1 of 2 fails, nothing's gonna happen in DB
// This is whole point of transaction for Relational Database (All or Nothing)
func main() {
	db, err := newDB()
	if err != nil {
	...
	// Test for null vs non-null type
